...
%  (shahrouzalima@gmail.com)
%
% Usage example:
%			mailsend('salimoha@ucsd.edu','Subject: Santa Claus coming to town','Message: Cheers');
...
if isempty(mailclient)
	mailclient.address = 'flowcontrol@gmail.com';
	mailclient.password = 'flowcontrol@ucsd';
